namespace Tests
{
    ...
    public class GelfAdapterTests
    {
        ...
        {
            var loggingEvent = this.CreateLogginEvent(new DummyLoggedObject {Info = "test"}, Level.DEBUG);
        ...
        {
            return new LoggingEvent(typeof(GelfAdapter).FullName, null, typeof(GelfAdapter).FullName, level, message, exception);
        }
