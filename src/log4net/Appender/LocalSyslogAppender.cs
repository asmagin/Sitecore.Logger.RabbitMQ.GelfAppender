...
namespace log4net.Appender
{
    ...
    public class LocalSyslogAppender : AppenderSkeleton
    {
        ...
        public override void ActivateOptions()
        {
            ...
            var identString = this.m_identity;
            if (identString == null)
            {
        ...
        {
            var levelSeverity = this.m_levelMapping.Lookup(level) as LevelSeverity;
        ...
        {
            var priority = GeneratePriority(this.m_facility, this.GetSeverity(loggingEvent.Level));
